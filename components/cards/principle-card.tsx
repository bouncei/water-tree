...
const PrincipleCard = ({ text, imgPath }: PrincipleCardProps) => {
  return (
    <div
      className={cn(
        "bg-primary/80  rounded-t-xl sm:rounded-t-full sm:rounded-tr-none sm:rounded-l-full max-w-[50vw] lg:max-w-screen-md p-5 flex flex-col-reverse sm:flex-row  items-center text-sm",
