...
const PrincipleCard = ({ text, imgPath }: PrincipleCardProps) => {
  return (
    <div
      className={cn(
        "bg-primary/80  rounded-t-xl lg:rounded-t-full lg:rounded-tr-none lg:rounded-l-full w-full  p-5 lg:py-0 lg:pr-0 flex flex-col-reverse lg:flex-row gap-5 lg:gap-0  items-center text-base"
        // imgPath === "/faith.png" && "max-w-[70vw] lg:max-w-screen-lg",
        // imgPath === "/anatomy.png" && "max-w-screen lg:max-w-screen-xl "
      )}
    >
      <div className="text-white text-xs  md:text-base lg:pr-5">{text}</div>
